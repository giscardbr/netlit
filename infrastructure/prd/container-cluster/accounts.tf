...
[
  ...
  },
  {
    ...
    "value": "http://authorization-server.netlit.local:8080/v1/oauth/user"
  },
  {
    "name": "AWS_SNS_TOPIC",
  ...
  },
  {
    ...
    "value": "https://sqs.us-east-1.amazonaws.com/478297097809/sendmail"
  },
  {
...
resource "aws_iam_role_policy" "accounts_sqs_policy" {
