...
@Service
@Validated
public class CityAdminWritingService {
  ...
  public CityAdminWritingService(
  ...
  public void create(final @Valid @NotNull CityAdminCreationHttpRequest request) {
...
//		orderRepository.save(order);
  ...
  @EventListener
  void create(final CityAdminCreationRequestEvent event) throws JsonProcessingException {
    log.info("New city admin request: " + this.mapper.writeValueAsString(event));
